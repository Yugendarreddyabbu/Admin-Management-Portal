                ...
                <div class="header-notifications-list">
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="msg-name">New Bookings <span class="msg-time float-end">2 min
                            ago</span></h6>
                        <p class="msg-info">You have recived new bookings</p>
                      </div>
                    </div>
                  </a>
                  <a class="dropdown-item" href="javascript:;">
                  ...
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="msg-name">New Bookings Recieved <span class="msg-time float-end">2 hrs ago</span></h6>
                        <p class="msg-info">Your new bookingss has recieved</p>
                      </div>
                    </div>
                  </a>
                  {/* <a class="dropdown-item" href="javascript:;">
                  ...
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="msg-name">New Message<span class="msg-time float-end">4 hrs
                            ago</span></h6>
                        <p class="msg-info">Message from XYZ garage</p>
                      </div>
                    </div>
                  </a>
                  {/* <a class="dropdown-item" href="javascript:;">
                  ...
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex flex-row align-items-center gap-2">
                      ...
                      <div class="">
                        ...
                        <small class="mb-0 dropdown-user-designation text-secondary">Chief Admin</small>
                      </div>
                    </div>
                  </a>
                </li>
